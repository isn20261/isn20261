"""Mock movie catalogue utilities.

This is shared by lambdas that need to resolve a movieId to a title without
calling external services (OMDB integration is pending).
"""
